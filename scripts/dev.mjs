...
const dev = spawn("concurrently", [
  "-n", "vite,tailwind,map,performance-pyramid,log,profile,account,account-edit,account-import,sync",
  "-c", "blue,magenta,yellow,cyan,white,gray,blue,magenta,cyan,yellow",
  "vite dev",
