...
├── <page>-app.js         One per client/*-main.js entry (16 total,
│                           #761) -- generated by `pnpm run client:build`
│                           (vite build), not committed. See "Client JS,
│                           real code-splitting" above and "Composition
│                           roots, one per page" below for the full list.
