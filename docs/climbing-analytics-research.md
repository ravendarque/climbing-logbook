...
- **Drill-down/rollup filters:** by place/area, grade, type, wall angle, hold type, style, date range, and status (send/project/archived/checkout) — enabling all of the above views to be sliced consistently rather than only viewed in aggregate.
