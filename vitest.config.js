    ...
    projects: [
      {
        test: {
          ...
          exclude: ["test/client/move-tagging.test.js", "test/client/time-window.test.js", "test/client/climbing-tab-bar.test.js"],
      ...
      },
      {
        test: {
          ...
          include: ["test/client/move-tagging.test.js", "test/client/time-window.test.js", "test/client/climbing-tab-bar.test.js"],
