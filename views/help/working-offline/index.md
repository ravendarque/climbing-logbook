...
You can log, edit and delete climbs with no signal. Climbing Logbook saves everything on your device first, then syncs it when you're back online.
...
Open Climbing Logbook once while you still have a connection. That's when it loads the app and your logbook onto your device. If you've never opened it online on that device, there's nothing to work from offline.
...
Related: [Grade scales & conversion](/help/grade-scales/).
